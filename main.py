...
# Kelurahan
cimenyan.kelurahanMekarsari('Mekarsari')
cimenyan.kelurahanCiburial('Ciburial')
cimenyan.kelurahanCibenying('Cibenying')
cimenyan.kelurahanCikadut('Cikadut')
cimenyan.kelurahanMandalamekar('Mandalamekar')
cimenyan.kelurahanSindanglaya('Sindanglaya')
cimenyan.kelurahanMekarmanik('Mekarmanik')
cimenyan.kelurahanCimenyan('Cimenyan')
cimenyan.kelurahanPadasuka('Padasuka')
cimenyan.kelurahanMekarsaluyu('Mekarsaluyu')

# Kantor
cimenyan.kantorKelurahanCibenying('kantor Kelurahan Cibenying')
cimenyan.kantorKelurahanCikadut('kantor Kelurahan Cikadut')
cimenyan.kantorKelurahanMandalamekar(' kantor Kelurahan Mandalamekar')
cimenyan.kantorKelurahanSindanglaya('kantor Kelurahan Sindanglaya')
cimenyan.kantorKelurahanMekarmanik('kantor Kelurahan Mekarmanik')
cimenyan.kantorKelurahanCimenyan('kantor Kelurahan cimenyan')
cimenyan.kantorKelurahanCiburial('kantor Kelurahan Ciburial')
cimenyan.kantorKelurahanMekarsaluyu('kantor Kelurahan Mekarsaluyu')
cimenyan.kantorKelurahanPadasuka('kantor Kelurahan Padasuka')

# jalan
cimenyan.jalanCiburial(' Jl. Ciburial - Mekarsaluyu ')
cimenyan.jalanMekarsaluyu(' Jl. Mekarsaluyu - Cibenying')
cimenyan.jalanCibenying(' Jl. Cibenying - cimenyan')
cimenyan.jalanCimenyan(' Jl. cimenyan - Mandalamekar')
cimenyan.jalanMandalamekar(' Jl. Mandalamekar - Cikadut')
cimenyan.jalanMekarmanik(' Jl. Mekarmanik - Sindanglaya')
cimenyan.close()
